...
<head>
    ...
    <title>BRAIN POS | Facturación Electrónica</title>
    <!-- Bootstrap Core CSS -->
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    ...
                    <?php } ?>
                        <!-- Logo icon -->
                        <b>
                            <img src="<?php echo URL; ?>public/images/logo-white.png" width="50%" style="margin-top: -5px;"/>
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                    ...
                    <ul class="navbar-nav mr-auto mt-md-0">
                        ...
                        <li class="nav-item search-box search-products" style="display: none"> <a class="nav-link text-muted waves-effect waves-dark" href="javascript:void(0)"><i class="ti-search"></i></a>
                            <form class="app-search">
                                <input type="text" class="form-control" name="buscar_producto" id="buscar_producto" placeholder="Buscar productos..." autocomplete="off"> <a class="srh-btn"><i class="ti-close"></i></a>
                            </form>
                        </li>
                        <!-- ============================================================== -->
                    </ul>
